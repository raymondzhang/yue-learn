...
const Gamification = {
  ...
  ALL_BADGES: [
    ...
    { id: 'stage_2', icon: '💬', name: '基础达标', desc: '完成基础级全部课程', condition: (d) => d.badges && d.badges.includes('stage_2') },
    { id: 'stage_3', icon: '🎯', name: '进阶达人', desc: '完成进阶级全部课程', condition: (d) => d.badges && d.badges.includes('stage_3') },
    { id: 'stage_4', icon: '🏆', name: '流利粤语', desc: '完成流利级全部课程', condition: (d) => d.badges && d.badges.includes('stage_4') },
